    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_rooms', models.ManyToManyField(null=True, related_name='departments', to='core.classroom')),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('taught_subjects', models.ManyToManyField(blank=True, related_name='teachers', to='core.subject')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_class', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.classroom')),
        ...
        migrations.AddField(
            model_name='subject',
            name='departments',
            field=models.ManyToManyField(through='core.SubjectAssignment', to='core.department'),
        ),
        migrations.CreateModel(
            name='Mark',
            fields=[
                ...
                ('total_mark', models.DecimalField(decimal_places=2, editable=False, max_digits=6)),
                ...
                ('modified_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='modified_marks', to=settings.AUTH_USER_MODEL)),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.student')),
                ('subject_assignment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.subjectassignment')),
            ],
        ),
        migrations.CreateModel(
            name='Term',
        ...
        migrations.AddField(
            ...
            name='term',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='core.term'),
        ),
